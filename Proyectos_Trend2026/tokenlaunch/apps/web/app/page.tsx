  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">TokenLaunch</h2>
      ...
      <p className="text-muted mb-8">Launchpad de tokens: IDO, LBP, vesting, anti-bot, KYC integrado.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• proyectos</li><li className="text-sm">• IDO</li><li className="text-sm">• vesting</li><li className="text-sm">• KYC</li><li className="text-sm">• staking tiers</li></ul>
        </div>
      </div>
