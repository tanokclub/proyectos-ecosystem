...
export const metadata = { title: "TokenLaunch", description: "Launchpad de tokens: IDO, LBP, vesting, anti-bot, KYC integrado." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">TokenLaunch</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4262</span></p>
              <p>Web: <span className="text-primary">:3262</span></p>
            </div>
          </nav>
