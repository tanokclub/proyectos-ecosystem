...
export const metadata = { title: "Sherpa AI", description: "Agente de soporte multicanal (web, WhatsApp, email) con tools y handoff humano." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">Sherpa AI</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4201</span></p>
              <p>Web: <span className="text-primary">:3201</span></p>
            </div>
          </nav>
