  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">RAGForge</h2>
      ...
      <p className="text-muted mb-8">Plataforma de RAG empresarial: ingesta, embeddings, índices, evaluación.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• pgvector</li><li className="text-sm">• Redis</li><li className="text-sm">• OpenAI</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• ingesta de documentos</li><li className="text-sm">• embeddings</li><li className="text-sm">• búsqueda híbrida</li><li className="text-sm">• chat con citas</li><li className="text-sm">• evaluación</li></ul>
        </div>
      </div>
