# Plan de Implementación — CarbonMarket

> Marketplace de créditos de carbono verificados (Verra, Gold Standard) LATAM.
...
- [ ] Modelos a crear: `projects`, `portfolio`, `buy`, `retire`, `metrics`, `notifications`, `search`, `batch`.
