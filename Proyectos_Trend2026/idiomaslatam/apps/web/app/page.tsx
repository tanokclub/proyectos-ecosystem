  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">IdiomasLATAM</h2>
      ...
      <p className="text-muted mb-8">Aprende idiomas nativos LATAM (quechua, guaraní, náhuatl, aymara, mapudungun).</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Whisper</li><li className="text-sm">• TTS</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• lecciones</li><li className="text-sm">• audio nativo</li><li className="text-sm">• speaking</li><li className="text-sm">• cultura</li><li className="text-sm">• comunidad</li></ul>
        </div>
      </div>
