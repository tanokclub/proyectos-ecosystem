  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">FitCoach</h2>
      ...
      <p className="text-muted mb-8">Entrenador AI con plan personalizado: ejercicio, recuperación, nutrición.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• plan</li><li className="text-sm">• rutinas</li><li className="text-sm">• wearable sync</li><li className="text-sm">• progreso</li><li className="text-sm">• comunidad</li></ul>
        </div>
      </div>
