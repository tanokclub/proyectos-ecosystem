...
export const metadata = { title: "SeguridadCom", description: "Vigilancia comunitaria: cámaras, IA detección, botón pánico, alertas vecinos." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">SeguridadCom</h1>
              <p className="text-xs text-muted mt-1">IoT / Smart Cities</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4274</span></p>
              <p>Web: <span className="text-primary">:3274</span></p>
            </div>
          </nav>
