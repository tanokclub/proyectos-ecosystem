  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CharityChain</h2>
      ...
      <p className="text-muted mb-8">Donaciones transparentes on-chain con milestones y verificación de impacto.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Foundry</li><li className="text-sm">• Solidity</li><li className="text-sm">• Ethers</li><li className="text-sm">• IPFS</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• campañas</li><li className="text-sm">• milestones</li><li className="text-sm">• donaciones</li><li className="text-sm">• verificación impacto</li><li className="text-sm">• reportes</li></ul>
        </div>
      </div>
