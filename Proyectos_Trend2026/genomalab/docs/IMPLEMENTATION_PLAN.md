# Plan de Implementación — GenomaLab

> Registro genómico personal con interpretación AI y privacidad zero-knowledge.
...
- [ ] Modelos a crear: `profiles`, `reports`, `upload`, `share`, `metrics`, `notifications`, `search`, `batch`.
