...
export const metadata = { title: "GenomaLab", description: "Registro genómico personal con interpretación AI y privacidad zero-knowledge." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">GenomaLab</h1>
              <p className="text-xs text-muted mt-1">HealthTech</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4227</span></p>
              <p>Web: <span className="text-primary">:3227</span></p>
            </div>
          </nav>
