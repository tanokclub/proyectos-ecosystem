  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">GenomaLab</h2>
      ...
      <p className="text-muted mb-8">Registro genómico personal con interpretación AI y privacidad zero-knowledge.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Snakemake</li><li className="text-sm">• IPFS</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• uploads</li><li className="text-sm">• pipeline</li><li className="text-sm">• variantes</li><li className="text-sm">• reportes</li><li className="text-sm">• sharing</li></ul>
        </div>
      </div>
