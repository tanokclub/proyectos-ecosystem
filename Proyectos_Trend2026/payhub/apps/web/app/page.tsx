  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">PayHub</h2>
      ...
      <p className="text-muted mb-8">Super-app de pagos: P2P, QR, recargas, servicios, cashback.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• wallet</li><li className="text-sm">• P2P</li><li className="text-sm">• QR</li><li className="text-sm">• recargas</li><li className="text-sm">• cashback</li></ul>
        </div>
      </div>
