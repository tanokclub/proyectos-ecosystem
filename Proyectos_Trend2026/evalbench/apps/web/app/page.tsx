  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">EvalBench</h2>
      ...
      <p className="text-muted mb-8">Plataforma para evaluar y comparar modelos LLM con datasets y métricas custom.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• ClickHouse</li><li className="text-sm">• Polars</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• datasets</li><li className="text-sm">• runs</li><li className="text-sm">• métricas</li><li className="text-sm">• comparador</li><li className="text-sm">• reportes</li></ul>
        </div>
      </div>
