...
export const metadata = { title: "EvalBench", description: "Plataforma para evaluar y comparar modelos LLM con datasets y métricas custom." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">EvalBench</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4205</span></p>
              <p>Web: <span className="text-primary">:3205</span></p>
            </div>
          </nav>
