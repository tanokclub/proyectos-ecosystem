...
export const metadata = { title: "KidsAcad", description: "Plataforma educativa para niños 5-12: gamification, parental control, currículo LATAM." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">KidsAcad</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4246</span></p>
              <p>Web: <span className="text-primary">:3246</span></p>
            </div>
          </nav>
