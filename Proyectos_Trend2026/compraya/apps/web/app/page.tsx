  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CompraYa</h2>
      ...
      <p className="text-muted mb-8">BNPL para retail LATAM: split en 3-12 cuotas sin intereses.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• checkout</li><li className="text-sm">• cuotas</li><li className="text-sm">• scoring</li><li className="text-sm">• cobranza</li><li className="text-sm">• merchants</li></ul>
        </div>
      </div>
