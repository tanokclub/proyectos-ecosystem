...
export const metadata = { title: "CompraYa", description: "BNPL para retail LATAM: split en 3-12 cuotas sin intereses." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">CompraYa</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4213</span></p>
              <p>Web: <span className="text-primary">:3213</span></p>
            </div>
          </nav>
