  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">EdgeFn</h2>
      ...
      <p className="text-muted mb-8">Edge functions LATAM con cold starts <50ms y KV global.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• V8 isolates</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Cloudflare style</li><li className="text-sm">• Anycast</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• funciones</li><li className="text-sm">• KV store</li><li className="text-sm">• cron</li><li className="text-sm">• observability</li><li className="text-sm">• deploy CLI</li></ul>
        </div>
      </div>
