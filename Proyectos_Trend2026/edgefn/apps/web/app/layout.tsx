...
export const metadata = { title: "EdgeFn", description: "Edge functions LATAM con cold starts <50ms y KV global." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">EdgeFn</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4257</span></p>
              <p>Web: <span className="text-primary">:3257</span></p>
            </div>
          </nav>
