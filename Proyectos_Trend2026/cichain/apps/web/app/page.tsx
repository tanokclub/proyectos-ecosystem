  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CIChain</h2>
      ...
      <p className="text-muted mb-8">CI/CD self-hosted compatible con GitHub Actions, ejecutores en cualquier nube.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Go</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Docker</li><li className="text-sm">• Redis</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• workflows</li><li className="text-sm">• runners</li><li className="text-sm">• artifacts</li><li className="text-sm">• secrets</li><li className="text-sm">• matrix</li></ul>
        </div>
      </div>
