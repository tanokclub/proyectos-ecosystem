...
export const metadata = { title: "CarbonTrack", description: "Medición de huella de carbono corporativa scope 1/2/3 con auto-reporte GHG." };
        ...
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4230</span></p>
              <p>Web: <span className="text-primary">:3230</span></p>
            </div>
          </nav>
