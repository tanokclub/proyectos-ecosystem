  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">VoiceClone Pro</h2>
      ...
      <p className="text-muted mb-8">Estudio para clonar voces, generar narraciones y voiceovers multilingües.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• ElevenLabs</li><li className="text-sm">• S3</li><li className="text-sm">• PostgreSQL</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• voces</li><li className="text-sm">• proyectos</li><li className="text-sm">• síntesis TTS</li><li className="text-sm">• studio</li><li className="text-sm">• API</li></ul>
        </div>
      </div>
