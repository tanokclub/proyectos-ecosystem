...
export const metadata = { title: "VoiceClone Pro", description: "Estudio para clonar voces, generar narraciones y voiceovers multilingües." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">VoiceClone Pro</h1>
              <p className="text-xs text-muted mt-1">AI/GenAI</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4202</span></p>
              <p>Web: <span className="text-primary">:3202</span></p>
            </div>
          </nav>
