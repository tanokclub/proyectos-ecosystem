...
export const metadata = { title: "ShortLAT", description: "Plataforma short video estilo TikTok con monetización LATAM y AI recommend." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">ShortLAT</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4283</span></p>
              <p>Web: <span className="text-primary">:3283</span></p>
            </div>
          </nav>
