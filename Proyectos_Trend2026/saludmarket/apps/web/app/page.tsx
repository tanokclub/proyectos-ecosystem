  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">SaludMarket</h2>
      ...
      <p className="text-muted mb-8">Marketplace de servicios de salud: estudios, vacunas, terapias a domicilio.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• catálogo</li><li className="text-sm">• agenda</li><li className="text-sm">• pagos</li><li className="text-sm">• proveedores</li><li className="text-sm">• reviews</li></ul>
        </div>
      </div>
