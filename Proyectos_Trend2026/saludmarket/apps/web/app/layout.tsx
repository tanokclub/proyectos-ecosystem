...
export const metadata = { title: "SaludMarket", description: "Marketplace de servicios de salud: estudios, vacunas, terapias a domicilio." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">SaludMarket</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4229</span></p>
              <p>Web: <span className="text-primary">:3229</span></p>
            </div>
          </nav>
