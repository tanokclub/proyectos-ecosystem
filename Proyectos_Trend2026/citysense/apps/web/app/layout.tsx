...
export const metadata = { title: "CitySense", description: "Smart city dashboard: sensores urbanos, alertas, gestión incidentes municipales." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">CitySense</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4270</span></p>
              <p>Web: <span className="text-primary">:3270</span></p>
            </div>
          </nav>
