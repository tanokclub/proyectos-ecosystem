  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">AgriDrone</h2>
      ...
      <p className="text-muted mb-8">Drones agrícolas para mapeo, monitoreo cultivos y aspersión de precisión.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• CV</li><li className="text-sm">• PX4</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• flotas drones</li><li className="text-sm">• misiones</li><li className="text-sm">• mapeo NDVI</li><li className="text-sm">• aspersión</li><li className="text-sm">• reportes</li></ul>
        </div>
      </div>
