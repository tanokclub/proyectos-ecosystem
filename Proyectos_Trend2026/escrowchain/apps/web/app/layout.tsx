...
export const metadata = { title: "EscrowChain", description: "Escrow on-chain para freelance, M&A y comercio internacional." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">EscrowChain</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4218</span></p>
              <p>Web: <span className="text-primary">:3218</span></p>
            </div>
          </nav>
