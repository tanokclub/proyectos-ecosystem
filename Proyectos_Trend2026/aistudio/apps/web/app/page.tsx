  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">AIStudio</h2>
      ...
      <p className="text-muted mb-8">Content generation AI para creators: thumbnails, scripts, ediciones, voiceovers.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Anthropic</li><li className="text-sm">• SD3</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• thumbnails</li><li className="text-sm">• scripts</li><li className="text-sm">• ediciones</li><li className="text-sm">• voiceovers</li><li className="text-sm">• translaciones</li></ul>
        </div>
      </div>
