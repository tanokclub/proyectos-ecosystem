# Plan de Implementación — LiveAuction

> Livestream commerce: subastas en vivo, ventas flash, gamification, multi-creator.
...
- [ ] Modelos a crear: `streams`, `products`, `bid`, `checkout`, `metrics`, `notifications`, `search`, `batch`.
