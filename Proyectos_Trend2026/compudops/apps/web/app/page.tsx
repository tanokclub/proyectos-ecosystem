  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CompudOps</h2>
      ...
      <p className="text-muted mb-8">Orchestrator de agentes computer-use: lanza, monitoriza y graba sesiones.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• noVNC</li><li className="text-sm">• Anthropic</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• sesiones</li><li className="text-sm">• tareas</li><li className="text-sm">• video</li><li className="text-sm">• aprobaciones</li><li className="text-sm">• audit</li></ul>
        </div>
      </div>
