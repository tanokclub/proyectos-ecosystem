  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">ClimaModel</h2>
      ...
      <p className="text-muted mb-8">Modelado climático local con descarga estadística y proyecciones IPCC.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• xarray</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Anthropic</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• scenarios</li><li className="text-sm">• descarga</li><li className="text-sm">• ensemble</li><li className="text-sm">• riesgos</li><li className="text-sm">• reportes</li></ul>
        </div>
      </div>
