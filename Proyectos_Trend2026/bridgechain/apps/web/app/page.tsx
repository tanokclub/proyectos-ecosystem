  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">BridgeChain</h2>
      ...
      <p className="text-muted mb-8">Bridge cross-chain optimizado para corredores LATAM (ETH↔ARB↔BASE↔OP).</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Foundry</li><li className="text-sm">• LayerZero</li><li className="text-sm">• Ethers</li><li className="text-sm">• PostgreSQL</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• cotización</li><li className="text-sm">• transferencia</li><li className="text-sm">• liquidity</li><li className="text-sm">• security</li><li className="text-sm">• monitoring</li></ul>
        </div>
      </div>
