...
export const metadata = { title: "ESGReport", description: "Auto-reporte ESG (TCFD, ISSB, GRI) con scoring AI y data lake." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">ESGReport</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4239</span></p>
              <p>Web: <span className="text-primary">:3239</span></p>
            </div>
          </nav>
