  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">APIMesh</h2>
      ...
      <p className="text-muted mb-8">API gateway open source: routing, auth, rate limit, transformaciones, observabilidad.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Envoy</li><li className="text-sm">• Lua</li><li className="text-sm">• Redis</li><li className="text-sm">• PostgreSQL</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• routes</li><li className="text-sm">• auth</li><li className="text-sm">• rate limit</li><li className="text-sm">• transforms</li><li className="text-sm">• plugins</li></ul>
        </div>
      </div>
