  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">ReforestaApp</h2>
      ...
      <p className="text-muted mb-8">Tracker satelital de proyectos de reforestación con verificación geoespacial.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostGIS</li><li className="text-sm">• Sentinel-2</li><li className="text-sm">• Anthropic</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• proyectos</li><li className="text-sm">• parcelas</li><li className="text-sm">• monitoreo NDVI</li><li className="text-sm">• verificación</li><li className="text-sm">• reportes</li></ul>
        </div>
      </div>
