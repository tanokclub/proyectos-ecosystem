...
export const metadata = { title: "CopiloC", description: "Copiloto de código para equipos: indexa el repo, genera PRs, hace code review." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">CopiloC</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4204</span></p>
              <p>Web: <span className="text-primary">:3204</span></p>
            </div>
          </nav>
