  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CopiloC</h2>
      ...
      <p className="text-muted mb-8">Copiloto de código para equipos: indexa el repo, genera PRs, hace code review.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• Tree-sitter</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Anthropic</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• indexing</li><li className="text-sm">• autocompletar</li><li className="text-sm">• PR gen</li><li className="text-sm">• review</li><li className="text-sm">• analytics</li></ul>
        </div>
      </div>
