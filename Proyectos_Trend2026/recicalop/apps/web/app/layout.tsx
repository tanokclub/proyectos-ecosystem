...
export const metadata = { title: "ReciclaLoop", description: "Plataforma de economía circular: residuos B2B + marketplace materiales reciclados." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">ReciclaLoop</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4236</span></p>
              <p>Web: <span className="text-primary">:3236</span></p>
            </div>
          </nav>
