  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CostMonitor</h2>
      ...
      <p className="text-muted mb-8">Cloud cost monitoring multi-nube con anomaly detection y optimización.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Python</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• ClickHouse</li><li className="text-sm">• AWS SDK</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• ingesta</li><li className="text-sm">• anomalies</li><li className="text-sm">• optimización</li><li className="text-sm">• budgets</li><li className="text-sm">• reports</li></ul>
        </div>
      </div>
