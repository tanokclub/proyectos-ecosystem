  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">AulaLAT</h2>
      ...
      <p className="text-muted mb-8">LMS LATAM con AI tutor, learning paths adaptativos y multi-idioma.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• cursos</li><li className="text-sm">• AI tutor</li><li className="text-sm">• evaluación</li><li className="text-sm">• gamification</li><li className="text-sm">• analytics</li></ul>
        </div>
      </div>
