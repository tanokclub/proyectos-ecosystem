...
export const metadata = { title: "AulaLAT", description: "LMS LATAM con AI tutor, learning paths adaptativos y multi-idioma." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">AulaLAT</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4240</span></p>
              <p>Web: <span className="text-primary">:3240</span></p>
            </div>
          </nav>
