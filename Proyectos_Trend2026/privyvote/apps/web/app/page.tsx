  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">PrivyVote</h2>
      ...
      <p className="text-muted mb-8">Voting privado ZK para DAOs, organizaciones y gobiernos: anónimo y verificable.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Foundry</li><li className="text-sm">• Circom</li><li className="text-sm">• Ethers</li><li className="text-sm">• PostgreSQL</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• proposals</li><li className="text-sm">• voting ZK</li><li className="text-sm">• tally</li><li className="text-sm">• audit</li><li className="text-sm">• verifiers</li></ul>
        </div>
      </div>
