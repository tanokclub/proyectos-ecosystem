...
export const metadata = { title: "PrivyVote", description: "Voting privado ZK para DAOs, organizaciones y gobiernos: anónimo y verificable." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">PrivyVote</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4267</span></p>
              <p>Web: <span className="text-primary">:3267</span></p>
            </div>
          </nav>
