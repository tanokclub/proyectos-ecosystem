...
export const metadata = { title: "SnapDB", description: "Postgres con branching estilo Git: snapshots instantáneos, branches por PR." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">SnapDB</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4256</span></p>
              <p>Web: <span className="text-primary">:3256</span></p>
            </div>
          </nav>
