  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">SnapDB</h2>
      ...
      <p className="text-muted mb-8">Postgres con branching estilo Git: snapshots instantáneos, branches por PR.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Postgres</li><li className="text-sm">• WAL</li><li className="text-sm">• S3</li><li className="text-sm">• Rust</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• branches</li><li className="text-sm">• snapshots</li><li className="text-sm">• restore</li><li className="text-sm">• permisos</li><li className="text-sm">• pricing</li></ul>
        </div>
      </div>
