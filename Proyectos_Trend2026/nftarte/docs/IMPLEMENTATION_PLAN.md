# Plan de Implementación — NFTArte

> Marketplace NFT arte LATAM con royalties on-chain y curaduría.
...
- [ ] Modelos a crear: `listings`, `auctions`, `mint`, `bid`, `metrics`, `notifications`, `search`, `batch`.
...
- `GET /api/v1/auctions` — Subastas
- `POST /api/v1/mint` — Mint
- `POST /api/v1/bid` — Bid
