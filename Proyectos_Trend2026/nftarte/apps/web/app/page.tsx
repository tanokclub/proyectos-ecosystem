  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">NFTArte</h2>
      ...
      <p className="text-muted mb-8">Marketplace NFT arte LATAM con royalties on-chain y curaduría.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• catálogo</li><li className="text-sm">• subastas</li><li className="text-sm">• royalties</li><li className="text-sm">• curaduría</li><li className="text-sm">• minting</li></ul>
        </div>
      </div>
