  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">WaterGrid</h2>
      ...
      <p className="text-muted mb-8">Gestión hídrica urbana: medición fugas, calidad, presión, alertas en tiempo real.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• TimescaleDB</li><li className="text-sm">• MQTT</li><li className="text-sm">• GIS</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• sensores</li><li className="text-sm">• fugas</li><li className="text-sm">• calidad</li><li className="text-sm">• consumo</li><li className="text-sm">• alertas</li></ul>
        </div>
      </div>
