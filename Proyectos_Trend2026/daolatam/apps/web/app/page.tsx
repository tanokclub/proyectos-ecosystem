  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">DAOLatAm</h2>
      ...
      <p className="text-muted mb-8">Gobernanza DAO LATAM: propuestas, votación on-chain, treasury, snapshots.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• propuestas</li><li className="text-sm">• votación</li><li className="text-sm">• treasury</li><li className="text-sm">• snapshots</li><li className="text-sm">• delegación</li></ul>
        </div>
      </div>
