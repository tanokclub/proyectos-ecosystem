...
export const metadata = { title: "DAOLatAm", description: "Gobernanza DAO LATAM: propuestas, votación on-chain, treasury, snapshots." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">DAOLatAm</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4260</span></p>
              <p>Web: <span className="text-primary">:3260</span></p>
            </div>
          </nav>
