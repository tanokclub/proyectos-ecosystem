  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">MusicSplit</h2>
      ...
      <p className="text-muted mb-8">Royalty splits para músicos: smart contracts, distribución automática, regalías globales.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Foundry</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Ethers</li><li className="text-sm">• Spotify API</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• canciones</li><li className="text-sm">• splits</li><li className="text-sm">• distribución</li><li className="text-sm">• cobros</li><li className="text-sm">• analytics</li></ul>
        </div>
      </div>
