...
export const metadata = { title: "MusicSplit", description: "Royalty splits para músicos: smart contracts, distribución automática, regalías globales." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">MusicSplit</h1>
              <p className="text-xs text-muted mt-1">Creator Economy</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4287</span></p>
              <p>Web: <span className="text-primary">:3287</span></p>
            </div>
          </nav>
