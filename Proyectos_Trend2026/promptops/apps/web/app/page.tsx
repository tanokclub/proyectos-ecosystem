  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">PromptOps</h2>
      ...
      <p className="text-muted mb-8">Versionado, testing y deploy de prompts en producción con métricas.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• ClickHouse</li><li className="text-sm">• Anthropic</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• versiones</li><li className="text-sm">• A/B testing</li><li className="text-sm">• eval</li><li className="text-sm">• observabilidad</li><li className="text-sm">• rollback</li></ul>
        </div>
      </div>
