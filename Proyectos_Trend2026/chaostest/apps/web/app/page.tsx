  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">ChaosTest</h2>
      ...
      <p className="text-muted mb-8">Chaos engineering as service: fault injection, game days, hipótesis automatizadas.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Go</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• eBPF</li><li className="text-sm">• Kubernetes</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• experimentos</li><li className="text-sm">• fault injection</li><li className="text-sm">• hypothesis</li><li className="text-sm">• reportes</li><li className="text-sm">• game days</li></ul>
        </div>
      </div>
