...
export const metadata = { title: "ChaosTest", description: "Chaos engineering as service: fault injection, game days, hipótesis automatizadas." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">ChaosTest</h1>
              <p className="text-xs text-muted mt-1">DevTools / Infra</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4258</span></p>
              <p>Web: <span className="text-primary">:3258</span></p>
            </div>
          </nav>
