...
export const metadata = { title: "RealEstateChain", description: "Fractionalize real estate: tokens ERC-3643, rentas on-chain, marketplace LATAM." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">RealEstateChain</h1>
              <p className="text-xs text-muted mt-1">Web3 / Blockchain</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4264</span></p>
              <p>Web: <span className="text-primary">:3264</span></p>
            </div>
          </nav>
