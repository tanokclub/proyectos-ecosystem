  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CronosHR</h2>
      ...
      <p className="text-muted mb-8">EHR open source LATAM: historial clínico unificado HL7/FHIR.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• HAPI FHIR</li><li className="text-sm">• OAuth2</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• pacientes</li><li className="text-sm">• encounters</li><li className="text-sm">• condiciones</li><li className="text-sm">• medicación</li><li className="text-sm">• observaciones</li></ul>
        </div>
      </div>
