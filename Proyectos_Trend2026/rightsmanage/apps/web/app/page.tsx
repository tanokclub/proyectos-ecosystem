  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">RightsManage</h2>
      ...
      <p className="text-muted mb-8">Gestión IP y derechos: catálogo, licenciamientos, takedowns, sync rights.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Elastic</li><li className="text-sm">• CMS</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• catálogo IP</li><li className="text-sm">• licencias</li><li className="text-sm">• takedowns</li><li className="text-sm">• sync rights</li><li className="text-sm">• analytics</li></ul>
        </div>
      </div>
