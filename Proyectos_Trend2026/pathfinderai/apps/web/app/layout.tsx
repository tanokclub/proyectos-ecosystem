...
export const metadata = { title: "PathfinderAI", description: "Coaching de carrera con AI: roadmap personalizado y matching de oportunidades." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">PathfinderAI</h1>
              <p className="text-xs text-muted mt-1">EdTech</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4241</span></p>
              <p>Web: <span className="text-primary">:3241</span></p>
            </div>
          </nav>
