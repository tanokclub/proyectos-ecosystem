  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">FanClub</h2>
      ...
      <p className="text-muted mb-8">Suscripciones fan: tiers, contenido exclusivo, comunidad, eventos virtuales.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Stripe</li><li className="text-sm">• WebRTC</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• tiers</li><li className="text-sm">• contenido</li><li className="text-sm">• comunidad</li><li className="text-sm">• eventos</li><li className="text-sm">• mensajería</li></ul>
        </div>
      </div>
