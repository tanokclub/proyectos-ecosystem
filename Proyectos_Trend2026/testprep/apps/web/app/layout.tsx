...
export const metadata = { title: "TestPrep", description: "Preparación adaptativa a exámenes oficiales: LSAT, MCAT, ICFES, ENEM, PAES." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">TestPrep</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4243</span></p>
              <p>Web: <span className="text-primary">:3243</span></p>
            </div>
          </nav>
