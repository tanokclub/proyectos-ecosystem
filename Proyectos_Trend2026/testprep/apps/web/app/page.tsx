  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">TestPrep</h2>
      ...
      <p className="text-muted mb-8">Preparación adaptativa a exámenes oficiales: LSAT, MCAT, ICFES, ENEM, PAES.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• XGBoost</li><li className="text-sm">• Anthropic</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• simulacros</li><li className="text-sm">• banco preguntas</li><li className="text-sm">• adaptive learning</li><li className="text-sm">• analytics</li><li className="text-sm">• tutor</li></ul>
        </div>
      </div>
