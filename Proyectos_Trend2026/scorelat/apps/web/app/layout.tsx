...
export const metadata = { title: "ScoreLAT", description: "Scoring crediticio AI con datos alternativos: telco, utilities, e-commerce." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">ScoreLAT</h1>
              <p className="text-xs text-muted mt-1">FinTech LATAM</p>
            </div>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4215</span></p>
              <p>Web: <span className="text-primary">:3215</span></p>
            </div>
          </nav>
