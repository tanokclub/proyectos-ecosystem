  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">DeployHaus</h2>
      ...
      <p className="text-muted mb-8">PaaS bare-metal LATAM: deploy Git-based, autoscaling, secretos, dominios.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• Docker</li><li className="text-sm">• Nomad</li><li className="text-sm">• PostgreSQL</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• apps</li><li className="text-sm">• builds</li><li className="text-sm">• autoscaling</li><li className="text-sm">• secretos</li><li className="text-sm">• dominios</li></ul>
        </div>
      </div>
