...
export const metadata = { title: "DeployHaus", description: "PaaS bare-metal LATAM: deploy Git-based, autoscaling, secretos, dominios." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">DeployHaus</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4252</span></p>
              <p>Web: <span className="text-primary">:3252</span></p>
            </div>
          </nav>
