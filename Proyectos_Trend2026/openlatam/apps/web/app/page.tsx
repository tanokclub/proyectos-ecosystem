  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">OpenLatAm</h2>
      ...
      <p className="text-muted mb-8">Open banking LATAM: agrega cuentas vía PIX, CoDi, PSE, CMF, CMA.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Redis</li><li className="text-sm">• Kafka</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• conexiones</li><li className="text-sm">• cuentas</li><li className="text-sm">• transacciones</li><li className="text-sm">• consents</li><li className="text-sm">• agregación</li></ul>
        </div>
      </div>
