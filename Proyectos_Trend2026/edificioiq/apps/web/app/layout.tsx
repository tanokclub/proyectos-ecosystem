...
export const metadata = { title: "EdificioIQ", description: "Building automation: HVAC, energía, ocupación, accesos, ESG en edificios." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">EdificioIQ</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4279</span></p>
              <p>Web: <span className="text-primary">:3279</span></p>
            </div>
          </nav>
