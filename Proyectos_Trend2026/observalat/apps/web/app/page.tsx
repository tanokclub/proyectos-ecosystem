  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">ObservaLAT</h2>
      ...
      <p className="text-muted mb-8">Observabilidad open source: logs, métricas, traces, alertas, OpenTelemetry.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• Go</li><li className="text-sm">• ClickHouse</li><li className="text-sm">• OpenTelemetry</li><li className="text-sm">• Redis</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• logs</li><li className="text-sm">• métricas</li><li className="text-sm">• traces</li><li className="text-sm">• alertas</li><li className="text-sm">• dashboards</li></ul>
        </div>
      </div>
