  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">BioWear</h2>
      ...
      <p className="text-muted mb-8">Biomarkers en tiempo real de wearables (HRV, SpO2, glucosa) con alertas.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• FastAPI</li><li className="text-sm">• TimescaleDB</li><li className="text-sm">• Kafka</li><li className="text-sm">• Anthropic</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• devices</li><li className="text-sm">• ingesta</li><li className="text-sm">• alertas</li><li className="text-sm">• tendencias</li><li className="text-sm">• sharing médico</li></ul>
        </div>
      </div>
