...
export const metadata = { title: "BioWear", description: "Biomarkers en tiempo real de wearables (HRV, SpO2, glucosa) con alertas." };
      ...
      <body className="min-h-screen bg-bg text-white">
        <div className="flex h-screen">
          <nav className="w-64 border-r border-surface p-4 flex flex-col">
            <div className="mb-6">
              <h1 className="text-xl font-bold text-primary">BioWear</h1>
            ...
            <div className="text-xs text-muted">
              <p>API: <span className="text-primary">:4228</span></p>
              <p>Web: <span className="text-primary">:3228</span></p>
            </div>
          </nav>
