  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">TriajeAI</h2>
      ...
      <p className="text-muted mb-8">Triage AI para urgencias y atención primaria con clasificación Manchester.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-surface rounded-xl p-5">
          ...
          <ul className="space-y-1"><li className="text-sm">• triage</li><li className="text-sm">• protocolos</li><li className="text-sm">• derivación</li><li className="text-sm">• audit</li><li className="text-sm">• analytics</li></ul>
        </div>
      </div>
