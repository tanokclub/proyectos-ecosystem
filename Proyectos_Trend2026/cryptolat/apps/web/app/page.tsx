  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">CryptoLat</h2>
      ...
      <p className="text-muted mb-8">Wallet cripto LATAM con on/off-ramp local (PIX, SPEI, PSE).</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Ethers</li><li className="text-sm">• Bitcore</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• wallet</li><li className="text-sm">• on-ramp</li><li className="text-sm">• off-ramp</li><li className="text-sm">• swap</li><li className="text-sm">• staking</li></ul>
        </div>
      </div>
