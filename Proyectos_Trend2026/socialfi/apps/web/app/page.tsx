  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-3xl font-bold">SocialFi</h2>
      ...
      <p className="text-muted mb-8">Social tokens y economía creator: monetización on-chain, gates de contenido.</p>
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Stack</h3>
          <ul className="space-y-1"><li className="text-sm">• Next.js 14</li><li className="text-sm">• NestJS</li><li className="text-sm">• PostgreSQL</li><li className="text-sm">• Ethers</li><li className="text-sm">• Redis</li></ul>
        </div>
        <div className="bg-surface rounded-xl p-5">
          <h3 className="text-sm text-muted mb-2">Módulos</h3>
          <ul className="space-y-1"><li className="text-sm">• tokens creator</li><li className="text-sm">• gating</li><li className="text-sm">• tips</li><li className="text-sm">• rewards</li><li className="text-sm">• marketplace</li></ul>
        </div>
      </div>
