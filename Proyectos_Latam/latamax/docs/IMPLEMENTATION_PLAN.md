# Plan de Implementación — LatamaX
...
- [ ] Modelos a crear: `feed`, `trends`, `posts`.
...
## Endpoints actuales
- `GET /api/v1/feed` — Timeline curada para LATAM
- `GET /api/v1/trends` — Temas en tendencia por pais
- `POST /api/v1/posts` — Crear un post y enviarlo a moderacion
