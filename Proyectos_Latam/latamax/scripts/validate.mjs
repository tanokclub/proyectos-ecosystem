...
import { project, apiRoutes } from '../packages/shared/src/manifest.mjs';
import { startServer } from '../apps/api/src/server.mjs';
...
const requiredPaths = [
  ...
  "packages/shared/src/manifest.mjs",
...
assert.equal(project.slug, "latamax");
