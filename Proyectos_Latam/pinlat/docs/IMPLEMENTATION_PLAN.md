...
- [ ] Modelos a crear: `feed`, `boards`, `categories`, `featured`, `pins`.
...
## Endpoints actuales
- `GET /api/v1/feed` — Feed visual principal
- `GET /api/v1/boards` — Tableros destacados
- `GET /api/v1/categories` — Categorias destacadas LATAM
- `GET /api/v1/pin/featured` — Pin destacado del dia
- `POST /api/v1/pins` — Crear pin en borrador
